...
public class DancerProcessServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // form에서 입력된 데이터를 읽어서 실제로 댄서 목록에 추가해줘야 함.
...
//        System.out.println("dancer = " + dancer);
        ...
        com.jsp.basic.chap02.DancerRepository.addDancer(dancer);

        // 목록에 잘 쌓이는지 확인
        List<Dancer> dancerList = com.jsp.basic.chap02.DancerRepository.getDancerList();
